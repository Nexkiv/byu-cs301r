...
**Assistant**: [ParsedResponseOutputText[TypeVar](annotations=[], text='Charlotte.', type='output_text', logprobs=[], parsed=None)]
...
**Total response time**: 17.80 seconds (1 responses, avg 17.80 seconds/response)